...
public class OuterRuleMembrane extends Membrane {
	...
	public OuterRuleMembrane(Label label, byte charge,List<InnerRuleMembrane> innerMembranes) {
		this(label, charge, new InmutableMultiSet<String>(), innerMembranes);
}		
	public OuterRuleMembrane(Label label, byte charge,int energy,List<InnerRuleMembrane> innerMembranes) {
		this(label, charge,energy, new InmutableMultiSet<String>(), innerMembranes);
		
	}
	
	public OuterRuleMembrane(Label label, byte charge,int energy1,int energy2,List<InnerRuleMembrane> innerMembranes) {
		this(label, charge,energy1, energy2, new InmutableMultiSet<String>(), innerMembranes);
	...
	public OuterRuleMembrane(Label label, byte charge,
		...
		public OuterRuleMembrane(Label label, byte charge,int energy,
			MultiSet<String> multiset, List<InnerRuleMembrane> innerMembranes) {
		super(label, charge, energy,multiset);
		if (innerMembranes == null)
			throw new NullPointerException(
					"InnerRuleMembrane list shouldn't be null");
		this.innerMembranes = innerMembranes;
	...
	public OuterRuleMembrane(Label label, byte charge,int energy1,int energy2,
			MultiSet<String> multiset, List<InnerRuleMembrane> innerMembranes) {
		super(label, charge, energy1, energy2,multiset);
		if (innerMembranes == null)
			throw new NullPointerException(
					"InnerRuleMembrane list shouldn't be null");
		this.innerMembranes = innerMembranes;
	...
	public OuterRuleMembrane(Label label, byte charge,int energy) {
		this(label, charge, energy, new ArrayList<InnerRuleMembrane>());
		// TODO Auto-generated constructor stub
	}
	...
	public String toString() {
		...
		if(getEnergy2()!=0){
		str += ",$" + Integer.toString(getEnergy2());}
		return str;
	}
