...
public class EvolutionCommunicationWithEnergyStringPsystemFactory extends
		AbstractCellLikePsystemFactory {

	private static EvolutionCommunicationWithEnergyStringPsystemFactory singleton = null;

	protected EvolutionCommunicationWithEnergyStringPsystemFactory() {
		super();
	...
	public static EvolutionCommunicationWithEnergyStringPsystemFactory getInstance()
	{
		if (singleton==null)
			singleton=new EvolutionCommunicationWithEnergyStringPsystemFactory();
		return singleton;
	}
