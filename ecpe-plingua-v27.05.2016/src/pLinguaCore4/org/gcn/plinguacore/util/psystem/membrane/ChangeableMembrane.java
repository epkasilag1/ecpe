...
public abstract class ChangeableMembrane extends Membrane {
	...
	public ChangeableMembrane(Label label, byte charge,int energy,MultiSet<String> multiSet) {
		super(label, charge, energy, multiSet);
		// TODO Auto-generated constructor stub
	}
	
	public ChangeableMembrane(Label label, byte charge,MultiSet<String> multiSet) {
	 ...
	 */
	public ChangeableMembrane(Label label, byte charge, int energy) {
		super(label, charge, energy);
	}
	
	public ChangeableMembrane(Label label, int energy) {
		super(label, energy);
	}
	...
	/**
	 * Creates a new ChangeableMembrane instance which charge is 0 and energy is 0
	 * 
	 * @param label
	 *            the label of the ChangeableMembrane instance to create
	 */
	...
	public final synchronized void setEnergy(int energy) {
		this.energy = energy;
	}

	public final synchronized void setEnergyPrev(){
		this.prevEnergy = getEnergy();
	}

	public final synchronized void setEnergyTemp(){
		this.tempEnergy = getEnergy();
	}

	public final synchronized void setEnergyTemp(int energy){
