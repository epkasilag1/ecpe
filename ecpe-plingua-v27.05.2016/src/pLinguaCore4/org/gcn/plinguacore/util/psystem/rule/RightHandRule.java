...
public class RightHandRule extends HandRule {
	...
	public String toString() {
	   ...
	   if(getOuterRuleMembrane().getEnergy()!=0)
			 str1+= "$" + Integer.toString(getOuterRuleMembrane().getEnergy());
		if (secondOuterMembrane != null){
			str2 += removeLabel(secondOuterMembrane.toString());
			if(secondOuterMembrane.getEnergy()!=0)
			str2+= "$" + Integer.toString(secondOuterMembrane.getEnergy());}
