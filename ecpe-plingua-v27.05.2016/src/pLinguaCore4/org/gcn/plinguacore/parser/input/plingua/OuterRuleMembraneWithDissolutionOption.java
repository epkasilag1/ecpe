...
class OuterRuleMembraneWithDissolutionOption extends OuterRuleMembrane{
	...
	public OuterRuleMembraneWithDissolutionOption(Label label, byte charge,int energy) {
	...
	public OuterRuleMembraneWithDissolutionOption(Label label, byte charge, int energy,MultiSet<String> multiset, List<InnerRuleMembrane> innerMembranes,boolean dissolves) {
            super(label, charge,energy, multiset, innerMembranes);
            this.dissolves=dissolves;
    }

	public OuterRuleMembraneWithDissolutionOption(Label label, byte charge,int energy, boolean dissolves) {
            super(label, charge,energy);
            this.dissolves=dissolves;
    }
