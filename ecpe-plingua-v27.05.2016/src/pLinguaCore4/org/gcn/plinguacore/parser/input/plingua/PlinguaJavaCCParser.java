...
class PlinguaJavaCcParser extends PlinguaProgram implements PlinguaJavaCcParserConstants {
        ...
        private boolean isECPesystem(){
                return getPsystem().getAbstractPsystemFactory().getModelName().equals("evolution_communication");
        }
  ...
  final private void ecpe_priority() throws ParseException {
                               Number priority;
    ...
    jj_consume_token(SEPARATOR);
                if (!getCurrentEnvironment().isSafeMode())
                {
                        ...
                        else
                        {
                                ...
                                if( ( (double) priority.longValue() ) != priority.doubleValue())
                                        {if (true) throw new Exception("Priority Mode must can be cast to int");}

                                if(priority.longValue() < 0L || priority.longValue() > 2L)
                                        {if (true) throw new Exception("Priority Mode must be in [0,1,2]");}

                                getPsystem().setECPePriority((int) priority.longValue());
                                writeInfo("Updating Priority Mode: ("+priority.longValue()+")",4);
                                }catch(Exception ex)
                                {
  ...
  final private OuterRuleMembraneWithDissolutionOption firstRightOuterRuleMembrane(Label label) throws ParseException {
    ...
    /*  jj_consume_token(-1);
      throw new ParseException();*/
         ...
         {if (true) return getCurrentEnvironment().isSafeMode()?null:new OuterRuleMembraneWithDissolutionOption(label,ch,energy.intValue(), ms,l,dissolves);}
    throw new Error("Missing return statement in function");
  }
  ...
  final private CellLikeMembrane cellLikeMembrane(CellLikeMembrane parentMembrane) throws ParseException {
    ...
    case DOLLAR:
      energy = energy();
                                 m = CellLikeMembraneFactory.getCellLikeMembrane(label,parentMembrane) ;     m.setEnergy(energy.intValue());
      break;
    default:
      jj_la1[46] = jj_gen;
     /* jj_consume_token(-1);
  ...
  final private void mast_binder() throws ParseException {
String label;
...
String r,s; boolean update,cOpFlag;
  ...
  final private void mast_wang() throws ParseException {
 ...
 if (!getCurrentEnvironment().isSafeMode())firstRightOuterRuleMembrane=new OuterRuleMembraneWithDissolutionOption(label,ch,rightOuterRuleMembraneMultiSet,rightInner,dissolves);
    ...
    default:
      ...
      ;
                ...
                {
                        endRuleToken=token;
                        leftOuterRuleMembrane=new OuterRuleMembrane(label,ch,energy1.intValue(),energy2.intValue(),leftOuterRuleMembraneMultiSet,leftInner);
  ...
  final private Number otherEnergy() throws ParseException {
                              Number energy2=0;
    energy2 = energy();
    jj_consume_token(ARROW);
         {if (true) return energy2;}
    throw new Error("Missing return statement in function");
  }
